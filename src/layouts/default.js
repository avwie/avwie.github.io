            ...
            <nav className="navbar navbar-dark bg-dark">
                <div className="container-lg d-flex">
                    ...
                    <div className="text-light mx-3">
                        <a className="px-2" title="Github" href="https://github.com/avwie" target="_blank" rel="noreferrer">
                        ...
                        <a className="px-2" title="Twitter" href="https://twitter.com/avwie" target="_blank" rel="noreferrer">
